...
@pytest.mark.parametrize("model_abbrev", ["GFS", "NAM", "RAP"])
@pytest.mark.parametrize("forecast_hour", [3, 12])
@pytest.mark.parametrize("pressure_mb", [1000, 925, 850, 700, 500, 300, 200])
...
@pytest.mark.parametrize("model_abbrev", ["NAVGEM"])
@pytest.mark.parametrize("forecast_hour", [3, 12])
